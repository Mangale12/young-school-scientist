    ...
    <div class="container">
        <div class="banner-profile--details d-flex align-items-center p-3">
            <div class="banner-profile--details--img me-3">
                <img src="{{asset('student-lms/assets/images/profile-avatar-legacy.png')}} " alt="img">
            </div>
            <div class="banner-profile--details--content">
                <h4 class="fw-bold">
                    Welcome back, {{ Auth::user()->name }}
                </h4>
                <p class="fs-5 fw-500">Grade: {{ Auth::user()->grade }} {{ Auth::user()->section }}  {{ Auth::user()->role }} <small class="fs-6"><i
